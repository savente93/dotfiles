...
pacstrap -K /mnt amd-ucode base curl firefox git i3-wm linux linux-firmware man-db man-pages networkmanager nvidia nvidia-utils openssl sddm sof-firmware sudo texinfo vim xorg-server wezterm alacritty
