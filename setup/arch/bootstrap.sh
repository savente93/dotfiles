...
pacstrap -K /mnt amd-ucode base curl firefox git sway linux linux-firmware man-db man-pages networkmanager mesa openssl sddm sof-firmware sudo texinfo vim wezterm alacritty
