...
function config_de() {
	sudo paru -S brightnessctl feh firefox flameshot i3-wm i3lock nvidia nvidia-utils pipewire pipewire-audio pipewire-pulse pulsemixer polybar helvum redshift rofi rofi-bluetooth-git sddm sddm-catppuccin-git ttf-firacode-nerd ttf-font-awesome tz wireplubmer xorg-xinput xss-lock yazi --noconfirm
